...
<body>
<form id="checkbox-form.php" action="" method="post" enctype="multipart/form-data">
...
<div id="wrapper">
    ...
    <div style="clear: both;">&nbsp;</div>
		...
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#"><font style="font-family:'Comic Sans MS', cursive">Welcome Mr.</font></a></h2>
				<div class="entry">

...
<table align="center">
                    <tr> 
                    <td><a href="profile.php"><h1 style="border-bottom:dotted">Update Profile</a></h1></td>
                   </tr>
                    <tr> 
                    <td><a href="sendm.php"><h1 style="border-bottom:dotted">Send Message</a></h1></td>
                   </tr>
                    <tr> 
                    <td><a href="inbox.php"><h1 style="border-bottom:dotted">Inbox Message(
                    <?php
						$con=mysqli_connect('localhost','root','','school');
						if(mysqli_connect_error()=='')
						{
                    ...
                    <td><a href="sent.php"><h1 style="border-bottom:dotted">Sent Message(
                    <?php
						$con=mysqli_connect('localhost','root','','school');
						if(mysqli_connect_error()=='')
						{

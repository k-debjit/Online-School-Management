...
<script src="js/jquery.validate.js"></script>
    ...
    //<![CDATA[
        ...
        function selectAllFiles(c) {
            for (i = 1; i <= 100; i++) {
                document.getElementById('chkFile'+i).checked = true;
            }
        }
...
<div id="wrapper">
		...
		<div id="header" class="container">
			...
			<div id="menu">
				<ul>
					...
					<li><a href="teacher.php"><font style="font-family:'Comic Sans MS', cursive">Main menu</font></a></li>
					<li><a href="t_logout.php"><font style="font-family:'Comic Sans MS', cursive">Log out</font></a></li>
				</ul>
			</div>
		</div>
    ...
    <div style="clear: both;">&nbsp;</div>
		...
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#"><font style="font-family:'Comic Sans MS', cursive"></font></a></h2>
				<div class="entry">
					<p><font style="font-family:'Comic Sans MS', cursive">
